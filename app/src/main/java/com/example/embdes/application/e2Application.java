package com.example.embdes.application;
...
public class e2Application extends Application {
    private static Context context;
    public static final String TAG = e2Application.class.getSimpleName();

    private static e2Application mInstance;
    ...
    public static synchronized e2Application getInstance() {
        return mInstance;
    }
...
//                    new com.example.embdes.Api.LruBitmapCache());
//        }
